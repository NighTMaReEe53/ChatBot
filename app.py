...
💡 قبل البدء بالتحليل:
حدّد أولًا نوع المستند (قانوني، مالي، إداري، شخصي، أكاديمي...) بناءً على محتواه،
ثم ابدأ الإجابة بجملة مثل: "📄 نوع المستند: سيرة ذاتية" أو "⚖️ نوع المستند: قانون ضريبي".

💡 ملاحظة إضافية:
إذا احتوى المستند على أكثر من نوع محتوى (مثلاً قانوني ومالي)، فقم بتحليله حسب الأقسام،
مع الإشارة بوضوح إلى نوع كل جزء قبل تحليله.
